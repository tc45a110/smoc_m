...
public class SmgpConstant {
	...
	//SMPP RequestId Set
	public static final int RID_LOGIN = 0x00000001;
	public static final int RID_LOGIN_RESP = 0x80000001;
	public static final int RID_SUBMIT = 0x00000002;
	public static final int RID_SUBMIT_RESP = 0x80000002;	
	public static final int RID_DELIVER = 0x00000003;
	public static final int RID_DELIVER_RESP = 0x80000003;	
	public static final int RID_ACTIVE_TEST = 0x00000004;
	public static final int RID_ACTIVE_TEST_RESP = 0x80000004;
	public static final int RID_EXIT = 0x00000006;
	public static final int RID_EXIT_RESP = 0x80000006;
	public static final int RID_QUERY = 0x00000007;
	public static final int RID_QUERY_RESP = 0x80000007;
