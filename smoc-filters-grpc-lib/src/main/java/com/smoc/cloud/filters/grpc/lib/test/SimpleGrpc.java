package com.smoc.cloud.filters.grpc.lib.test;
...
@javax.annotation.Generated(
    ...
    comments = "Source: com.test/hello.proto")
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.smoc.cloud.filters.grpc.lib.test.HelloRequest,
      com.smoc.cloud.filters.grpc.lib.test.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.smoc.cloud.filters.grpc.lib.test.HelloRequest.class,
      responseType = com.smoc.cloud.filters.grpc.lib.test.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.smoc.cloud.filters.grpc.lib.test.HelloRequest,
      com.smoc.cloud.filters.grpc.lib.test.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.smoc.cloud.filters.grpc.lib.test.HelloRequest, com.smoc.cloud.filters.grpc.lib.test.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.smoc.cloud.filters.grpc.lib.test.HelloRequest, com.smoc.cloud.filters.grpc.lib.test.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smoc.cloud.filters.grpc.lib.test.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smoc.cloud.filters.grpc.lib.test.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.smoc.cloud.filters.grpc.lib.test.HelloRequest request,
        io.grpc.stub.StreamObserver<com.smoc.cloud.filters.grpc.lib.test.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.smoc.cloud.filters.grpc.lib.test.HelloRequest,
                com.smoc.cloud.filters.grpc.lib.test.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
     ...
     * </pre>
     */
    public com.smoc.cloud.filters.grpc.lib.test.HelloReply sayHello(com.smoc.cloud.filters.grpc.lib.test.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.smoc.cloud.filters.grpc.lib.test.HelloReply> sayHello(
        com.smoc.cloud.filters.grpc.lib.test.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.smoc.cloud.filters.grpc.lib.test.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.smoc.cloud.filters.grpc.lib.test.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.smoc.cloud.filters.grpc.lib.test.HelloWorldProto.getDescriptor();
    }
