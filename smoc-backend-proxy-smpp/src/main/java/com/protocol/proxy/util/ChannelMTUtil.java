...
public class ChannelMTUtil {
	...
	//默认编码
	protected final static String DEFAULT_ENCODING = "0";
	
	protected static Map<String,String> charsetMap = new HashMap<String, String>();
	
	static{
		charsetMap.put("0", "US-ASCII");
		charsetMap.put("1", "US-ASCII");
		charsetMap.put("8", "UTF-16BE");
	}
	
	static Map<Byte,Integer> lengthMap = new HashMap<Byte, Integer>();
	
	static{
		lengthMap.put((byte)0, 160);
		lengthMap.put((byte)1, 160);
		lengthMap.put((byte)8, 140);
	}
