...
{
	public static final Logger logger = Logger.getLogger(SMPPDeliverMessage.class);
...
*/
    ...
    {
        return getFirstStr(3);
    }
    
    private byte[] getFirstStr(int sPos)
    {
        int length = 0;
        int pos;
        for(pos = sPos; pos < shortMessage.length; pos++){
        	//System.out.println(pos);
        	//byte=32(空格)时,退出
        	 if(shortMessage[pos] == 32){
        		 break;
        	 }
        	 length++;
        }
        ...
        System.arraycopy(shortMessage, sPos, tmpBuf, 0, length);
    ...
    public String toString()
    {
        ...
        strBuf.append(",ShortMessageBase64=".concat(Base64.byteArrayToBase64(getShortMessage())));
