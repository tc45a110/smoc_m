...
public class CMPPConnectMessage extends CMPPMessage {
	...
	public CMPPConnectMessage(String source_Addr, int version,
		...
		if (source_Addr == null)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String
							.valueOf(CMPPConstant.CONNECT_INPUT_ERROR))))
							.append(":source_Addr").append(
									CMPPConstant.STRING_NULL))));
		...
		System.arraycopy(source_Addr.getBytes(), 0, super.buf, 12,
				source_Addr.length());
		...
		int tmploc = 0;
		System.arraycopy(source_Addr.getBytes(), 0, tmpbuf, 0,
				source_Addr.length());
		...
		outStr = ",source_Addr=".concat(String.valueOf(String
				.valueOf(source_Addr)));
		outStr = String.valueOf(String.valueOf((new StringBuffer(String
				.valueOf(String.valueOf(outStr)))).append(",version=").append(
				version)));
		outStr = String.valueOf(String.valueOf((new StringBuffer(String
				.valueOf(String.valueOf(outStr)))).append(",shared_Secret=")
				.append(shared_Secret)));
		outStr = String.valueOf(String.valueOf((new StringBuffer(String
				.valueOf(String.valueOf(outStr)))).append(",timeStamp=")
				.append(tmptime)));
	}
