...
public class MessageWebTaskInfoRepositoryImpl extends BasePageRepository {
     ...
     * @return
     */
    public PageList<MessageWebTaskInfoValidator> httpPage(PageParams<MessageWebTaskInfoValidator> pageParams) {
        ...
        Object[] params = new Object[paramsList.size()];
        paramsList.toArray(params);
        PageList<MessageWebTaskInfoValidator> pageList = this.queryByPageForMySQL(sqlBuffer.toString(), params, pageParams.getCurrentPage(), pageParams.getPageSize(), new MessageHttpTaskInfoRowMapper());
        pageList.getPageParams().setParams(qo);
        return pageList;
    }
