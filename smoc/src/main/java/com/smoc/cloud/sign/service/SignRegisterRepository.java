...
public class SignRegisterRepository {
    ...
    public List<SignChannel> findChannelByAccount(String account) {
        ...
        sql.append(" where ac.CHANNEL_ID = ci.CHANNEL_ID and ac.CHANNEL_ID = c.CHANNEL_ID  and ac.ACCOUNT_ID=?");
    ...
    public List<SignChannel> findRepairChannelByAccount(String account) {
        ...
        sql.append(" where ac.CHANNEL_REPAIR_ID = ci.CHANNEL_ID and ac.CHANNEL_REPAIR_ID = c.CHANNEL_ID  and ac.BUSINESS_ID=?");
