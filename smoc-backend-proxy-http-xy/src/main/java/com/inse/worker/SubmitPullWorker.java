...
import com.inse.manager.AccountChannelTemplatelnfoManager;
    ...
    protected void doRun() throws Exception{
        ...
        try {
            if (businessRouteValue != null) {
                ...
                jsonobject.put("extNumber", businessRouteValue.getAccountSubmitSRCID());

                List<String> PhonesList = new ArrayList<String>();
                //获取通道模板标识,1表示普通模板,2 表示变量模板
                if ("1".equals(AccountChannelTemplatelnfoManager .getInstance().getTemplateFlag(templateId))) {
