package com.smoc.cloud.auth.redis;
 ...
 **/
@Component
public class MpmRedisTokenStore implements TokenStore {
    ...
    public MpmRedisTokenStore(RedisConnectionFactory connectionFactory) {
