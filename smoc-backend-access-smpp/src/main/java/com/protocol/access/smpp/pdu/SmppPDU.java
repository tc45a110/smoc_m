...
import com.protocol.access.smpp.sms.PDU;
 ...
 */
public abstract class SmppPDU extends PDU  {

	private static int sequenceNumber = 0;

	private boolean sequenceNumberChanged = false;

	public SmppPDUHeader header = null;

	public SmppPDU() {
		header = new SmppPDUHeader();
	}
	...
	public void setCommandStatus(int status) {
		checkHeader();
		header.setCommandStatus(status);
	}
	...
	public boolean equals(Object object) {
		if ((object != null) && (object instanceof SmppPDU)) {
			SmppPDU pdu = (SmppPDU) object;
