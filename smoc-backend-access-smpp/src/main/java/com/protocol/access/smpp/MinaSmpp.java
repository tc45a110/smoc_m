 ...
 * 
 */
public class MinaSmpp extends IoHandlerAdapter {
	private static final Logger logger = LoggerFactory
			.getLogger(MinaSmpp.class);
	...
	public MinaSmpp() throws IOException {
		...
		acceptor.getFilterChain().addLast("codec", new ProtocolCodecFilter(new SmppProtocolCodecFactory()));
	...
	public synchronized void start() throws Exception {
		final InetSocketAddress socketAddress = new InetSocketAddress(
				"0.0.0.0", PORT);
		acceptor.setHandler(new SmppIoHandler());
