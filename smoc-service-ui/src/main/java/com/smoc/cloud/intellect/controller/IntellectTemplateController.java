...
import com.smoc.cloud.intellect.remote.request.RequestGetTemplateStatus;
import com.smoc.cloud.intellect.remote.request.RequestQueryTemplates;
import com.smoc.cloud.intellect.remote.response.ResponseDataUtil;
import com.smoc.cloud.intellect.remote.response.ResponseGetTemplateStatus;
import com.smoc.cloud.intellect.remote.response.ResponseTemplateInfo;
import com.smoc.cloud.intellect.remote.service.RequestService;
import com.smoc.cloud.intellect.service.IntellectTemplateInfoService;
...
@Slf4j
@RestController
@RequestMapping("intellect/template")
...
public class IntellectTemplateController {
    ...
    public ModelAndView list(HttpServletRequest request) {
        ModelAndView view = new ModelAndView("intellect/template/template_list");
        ...
        intellectTemplateInfoValidator.setEnterpriseId(user.getOrganization());
    ...
    public ModelAndView page(@ModelAttribute IntellectTemplateInfoValidator intellectTemplateInfoValidator, PageParams pageParams, HttpServletRequest request) {
        ModelAndView view = new ModelAndView("intellect/template/template_list");
    ...
    public ModelAndView view_json(@PathVariable String templateId) {
        ModelAndView view = new ModelAndView("intellect/template/template_json_view");
    ...
    public ModelAndView submit(@PathVariable String templateId) {
        ...
        view.setView(new RedirectView("/intellect/template/list", true, false));
        return view;
     ...
     * @return
     */
    @RequestMapping(value = "/template_main/{accountId}/{action}/{templateId}", method = RequestMethod.GET)
    public ModelAndView template_main(@PathVariable String accountId, @PathVariable String action, @PathVariable String templateId, HttpServletRequest request) {

        ModelAndView view = new ModelAndView("intellect/template/template_main");
        ...
        view.addObject("enterpriseId", user.getOrganization());
    ...
    public Map<String, String> save(@RequestBody IntellectTemplateInfoValidator intellectTemplateInfoValidator, @PathVariable String accountId, HttpServletRequest request) {
