...
@Slf4j
@RestController
@RequestMapping("intellect/short/url")
public class IntellectShortUrlController {
    ...
    public ModelAndView list(HttpServletRequest request) {
        ...
        intellectShortUrlValidator.setCustFlag(user.getOrganization());
    ...
    public ModelAndView page(@ModelAttribute IntellectShortUrlValidator intellectShortUrlValidator, PageParams pageParams, HttpServletRequest request) {
        ModelAndView view = new ModelAndView("intellect/short_link/short_link_list");
     ...
     * @return
     */
    @RequestMapping(value = "/add/{accountId}/{tplId}", method = RequestMethod.GET)
    public ModelAndView add(@PathVariable String accountId, @PathVariable String tplId, HttpServletRequest request) {
    ...
    public ModelAndView generate(@ModelAttribute ShortLinkModel shortLinkModel, HttpServletRequest request) {
        ...
        requestParamList.setCustFlag(user.getOrganization());
        ...
        view.setView(new RedirectView("/intellect/short/url/list", true, false));
        return view;
