...
import com.smoc.cloud.intelligence.remote.request.RequestTemplateResource;
import com.smoc.cloud.intelligence.remote.service.RequestService;
import com.smoc.cloud.intelligence.remote.utils.FileBase64Converter;
...
public class IntellectMaterialService {
    ...
    public ResponseData save(IntellectMaterialValidator intellectMaterialValidator, List<MultipartFile> files, String op) {
        try {
            ...
            com.smoc.cloud.intelligence.remote.response.ResponseDataUtil<Map<String, String>> responseDataUtil = requestService.uploadTemplateResource(requestTemplateResource);
