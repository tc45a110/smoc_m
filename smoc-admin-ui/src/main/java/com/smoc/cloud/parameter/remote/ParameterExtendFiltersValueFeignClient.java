...
public interface ParameterExtendFiltersValueFeignClient {
     ...
     * @return
     */
    @RequestMapping(value = "/parameter/findParameterValue/{businessId}", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/parameter/save/{businessId}", method = RequestMethod.POST)
