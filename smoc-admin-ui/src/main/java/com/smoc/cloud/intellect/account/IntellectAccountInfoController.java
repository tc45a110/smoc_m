...
public class IntellectAccountInfoController {
    ...
    public ModelAndView list() {
        ModelAndView view = new ModelAndView("intellect/account/account_list");
    ...
    public ModelAndView search_list() {
        ModelAndView view = new ModelAndView("intellect/account/account_search_list");
    ...
    public ModelAndView add(@PathVariable String enterpriseId, HttpServletRequest request) {
        ModelAndView view = new ModelAndView("intellect/account/account_edit");
    ...
    public ModelAndView save(@ModelAttribute @Validated SystemAccountInfoValidator systemAccountInfoValidator, BindingResult result, @PathVariable String op, HttpServletRequest request) {
        ...
        view.setView(new RedirectView("/intellect/account/list", true, false));
        return view;
    ...
    public ModelAndView center(@PathVariable String id, HttpServletRequest request) {
        ModelAndView view = new ModelAndView("intellect/account/account_view_center");
