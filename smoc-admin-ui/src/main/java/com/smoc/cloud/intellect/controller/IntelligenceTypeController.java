...
import com.smoc.cloud.intellect.service.IntellectMaterialTypeService;
...
public class IntelligenceTypeController {
    ...
    public ModelAndView menuMain() {
        ...
        ModelAndView view = new ModelAndView("intellect/resource/resource_main");
    ...
    public ModelAndView getEnterprisePage() {
        ModelAndView view = new ModelAndView("intellect/resource/resource_enterprise_list");
        ResponseData<List<Nodes>> nodes = enterpriseService.findByAccountBusinessType("INTELLECT_SMS");
    ...
    public ModelAndView getAccountPage(@PathVariable String enterpriseId) {
        ...
        ModelAndView view = new ModelAndView("intellect/resource/resource_account_list");
    ...
    public ModelAndView getResourceTypePage(@PathVariable String parentId) {
        ...
        ModelAndView view = new ModelAndView("intellect/resource/resource_type_list");
        ResponseData<List<IntellectMaterialTypeValidator>> resourceTypeData = intellectMaterialTypeService.findIntellectMaterialTypeByParentIdAndStatus(parentId);
        if (!ResponseCode.SUCCESS.getCode().equals(resourceTypeData.getCode())) {
    ...
    public ModelAndView add(@PathVariable String enterpriseId, @PathVariable String parentId) {
        ModelAndView view = new ModelAndView("intellect/resource/resource_type_edit");
