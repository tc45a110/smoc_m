package com.smoc.cloud.http.filters.filter.full_filter;

import com.smoc.cloud.common.filters.utils.RedisConstant;
import com.smoc.cloud.common.response.ResponseData;
import com.smoc.cloud.common.response.ResponseDataUtil;
import com.smoc.cloud.http.filters.request.model.RequestFullParams;
import com.smoc.cloud.http.filters.service.FiltersRedisDataService;
import com.smoc.cloud.http.filters.service.FiltersService;
import com.smoc.cloud.http.filters.service.account.CarrierDailyLimiterFilter;
import com.smoc.cloud.http.filters.service.account.MaskProvinceFilter;
import com.smoc.cloud.http.filters.service.account.SendTimeLimitFilter;
import com.smoc.cloud.http.filters.service.message.ChannelMessageFilter;
import com.smoc.cloud.http.filters.service.message.ExtendMessageParamsFilter;
import com.smoc.cloud.http.filters.service.message.FullMessageFilter;
import com.smoc.cloud.http.filters.service.number.ExtendNumberParamsFilter;
import com.smoc.cloud.http.filters.service.number.IndustryBlackListFilter;
import com.smoc.cloud.http.filters.service.number.PhoneSendFrequencyLimitFilter;
import com.smoc.cloud.http.filters.service.number.SystemPhoneFilter;
...
@Slf4j
@Component
public class FullFilterParamsFilter {
    ...
    public ResponseData filter(RequestFullParams model) {
         ...
         * 根据手机号获取运营商
         */
        Object segmentCarrier = filtersRedisDataService.hget(RedisConstant.FILTERS_CONFIG_SYSTEM_CARRIER_NUMBER, model.getPhone().substring(0, 3));
        if (null == segmentCarrier) {
            segmentCarrier = filtersRedisDataService.hget(RedisConstant.FILTERS_CONFIG_SYSTEM_CARRIER_NUMBER,model.getPhone().substring(0, 4));
        }
...
//        }
     ...
     * @return
     */
    public ResponseData errorHandle(String errorCode, String errorMessage) {

        return ResponseDataUtil.buildError(errorCode, errorMessage);
    }
