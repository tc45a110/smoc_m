...
public class DAO {
    ...
    public static void updateAccountChannelTemplateInfo(String channelTemplateStatus,String statusDesc,String channelID,String templateId) {
        StringBuffer sql = new StringBuffer();
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            conn.setAutoCommit(false);
            pstmt = conn.prepareStatement(sql.toString());
            pstmt.setString(1,channelTemplateStatus);
