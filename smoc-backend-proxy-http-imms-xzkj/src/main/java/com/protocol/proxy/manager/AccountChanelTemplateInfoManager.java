...
public class AccountChanelTemplateInfoManager extends SuperMapWorker<String, AccountChanelTemplateInfoManager.AccountChannelTemplateInfo> {
    ...
    public String getChannelTemplateID(String templateID) {
        AccountChannelTemplateInfo templateInfo = get(templateID);
    ...
    public void loadData() {
        ...
        Map<String, AccountChannelTemplateInfo > templateMap = new HashMap<String, AccountChannelTemplateInfo>();
        try {
            conn = LavenderDBSingleton.getInstance().getConnection();
            pstmt = conn.prepareStatement(sql.toString());
            rs = pstmt.executeQuery();
            while (rs.next()) {
                AccountChannelTemplateInfo  accountchanneltemplateinfo = new AccountChannelTemplateInfo();
