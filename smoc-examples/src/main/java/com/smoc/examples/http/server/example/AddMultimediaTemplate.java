...
public class AddMultimediaTemplate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //业务账号；参见给的账号EXCEL文件
        requestDataMap.put("account", "YQT119");
        ...
        param.put("mediaFile", FileBASE64Utils.getFileToBase64("F:\\a.jpg"));
        mediaItems.add(param);
        //System.out.println("[接口请求][param]数据:" + new Gson().toJson(param));
        ...
        param1.put("mediaFile", FileBASE64Utils.getFileToBase64("F:\\a.jpg"));
        ...
        String sign = HMACUtil.md5_HMAC_sign(signData.toString(), "nr?FNIM8D");
