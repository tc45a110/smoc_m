...
//            header.put("signature-nonce", "202206221043192902026871940");
            ...
            //业务账号；参见给的账号EXCEL文件
            requestDataMap.put("account", "YQT154");
            //模板ID
            requestDataMap.put("templateId", "TEMP100631");
            ...
            String sign = HMACUtil.md5_HMAC_sign(signData.toString(), "IdhReh8M8");
