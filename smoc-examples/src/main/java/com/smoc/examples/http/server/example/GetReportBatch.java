...
public class GetReportBatch {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "http://localhost:18088/smoc-gateway/http-server/report/getReportBatch";
        ...
        requestDataMap.put("endDate", DateTimeUtils.getDateFormat(new Date(), "yyyy-MM-dd"));
