...
import com.smoc.cloud.common.gateway.request.IotRequestSignModel;
...
public class IotGatewayFilter {
     ...
     */
    @Bean
    public GatewayFilter iotServerGatewayFilter() {
        return new GatewayFilter() {
            ...
            public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
                ...
                //校验数据请求的数据结构
                IotRequestSignModel model;
                try {
                    model = new Gson().fromJson(requestBody, IotRequestSignModel.class);
                } catch (Exception e) {
