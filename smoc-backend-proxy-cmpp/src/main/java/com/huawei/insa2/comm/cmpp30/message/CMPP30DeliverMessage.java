...
public class CMPP30DeliverMessage extends CMPPMessage {
	...
	public String toString() {
		...
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String
				.valueOf(String.valueOf(tmpStr)))).append(",MsgId=").append(TypeConvert.byte2long(getMsgId()))));
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String
		...
		if (getRegisteredDeliver() == 1) {
			...
			tmpStr = String.valueOf(String.valueOf((new StringBuffer(String
					.valueOf(String.valueOf(tmpStr)))).append(",msg_Content_base64=")
					.append( Base64.byteArrayToBase64(getMsgContent()) )));
		}
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String
